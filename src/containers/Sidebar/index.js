              ...
              <Nav vertical className="list-unstyled">
                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "dhr" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="dhr")
                  })}
                >
                  <NavLink
                    to="/app/dhr"
                    onClick={e => this.openSubMenu(e, "dhr")}
                  >
                    <i className="iconsmind-Air-Balloon" />{" "}
                    <IntlMessages id="menu.dhr" />
                  </NavLink>
                </NavItem>
                <NavItem
                  className={classnames({
        ...
        <div className="sub-menu">
          <div className="scroll">
            ...
            >
              <Nav
                className={classnames({
                  "d-block": ((this.state.selectedParentMenu == "dhr" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="dhr")
                })}
                data-parent="dhr"
              >
                <NavItem>
                  <NavLink to="/app/dhr/start">
